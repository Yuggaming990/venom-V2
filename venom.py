...
TOKEN = '7441887717:AAEUkNSEBjxJrGoEDQ9u9P5xQI8a6agTVz4'
...
FORWARD_CHANNEL_ID = -4212379594
CHANNEL_ID = -4212379594
error_channel_id = -4212379594
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*Contact admin @Supernova1212*", parse_mode='Markdown')
    else:
